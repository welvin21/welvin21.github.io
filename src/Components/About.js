  ...
  return (
    <div className="description">
      ...
      <p>
        ...
        efficient solutions. I also love the logic of coding and always aim to
        be better at it, be it developing an application, building a machine
        learning model, or solving a competitive programming problem.
      </p>
      <p>I like physics and everything related to space exploration.</p>
      <p>
        In my leisure time, I read science-fiction books and play the guitar.{' '}
      </p>
    </div>
  );
};
          ...
          {socials.map(social => {
            return (
              <Icon
                ...
                type={social.title}
                key={social.title}
                onClick={() => openSocialMedia(social)}
              />
            );
          })}
        </div>
